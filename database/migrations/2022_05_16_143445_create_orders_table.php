...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('subtotal', 10, 2); // Example: 10 total digits with 2 after the decimal point
            $table->decimal('commission_owed', 10, 2)->default(0.00); // Similar precision as subtotal
